...
@Component({
  ...
  templateUrl: './promocion-edit.page.html',
  styleUrls: ['./promocion-edit.page.scss'],
})
export class PromocionEditPage implements OnInit {
  ...
  async submit() {
    ...
    try {
      await this.promocionesService.updatePromocion(this.promocion);
    ...
    this.route.params.subscribe(async params => {
      ...
      if (this.idPromocion) {
        try {
          ...
          if (!!this.promocion.imagenPromo) {
            this.isUploaded = true
            this.linkImagen = this.promocion.imagenPromo
          }
